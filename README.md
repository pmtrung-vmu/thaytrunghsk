...
- **"Cách viết"** hiện chỉ bật cho HSK1-3 (đúng theo yêu cầu ban đầu) — có thể mở rộng sang HSK4-9 nếu cần, chỉ cần thêm level vào danh sách `STROKE_ORDER_LEVELS` trong `js/app.js`.
